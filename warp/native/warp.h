...
extern "C"
{
    ...
    WP_API uint64_t wp_texture_create_device(void* context, void* data_ptr, uint64_t size_in_bytes, int width, int height, int channels, int format, int normalized_coords, int address_mode /*enum*/, int filter_mode /*enum*/);
